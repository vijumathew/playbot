...
var CreateApp = function() {
  ...
  this.runScript = function(client, userOptions) {
    ...
    util.step("Go to new application screen", function() {
      ...
      util.action("Click on element", ['button', ['Add new application', 'Publish an Android App on Google Play']]);
    });

    util.step("Wait for app dialogue and fill in app information", function() {
