...
var UpdateApp = function() {
  ...
  this.runScript = function(client, userOptions) {
    ...
    //checking to see if object has any of these properties
    var hasProperty = function(obj, properties) {
    ...
    if (hasProperty(userOptions, ['app_type', 'category', 'rating', 'short_description', 'full_description', 
      'promo_vid', 'website', 'email', 'phone', 'hi_res', 'feat_graphic', 'promo_graphic', 'screenshots_phone', 
      'screenshots_7', 'screenshots_10'])) {
    ...
    if (hasProperty(userOptions, ['education', 'locations', 'marketing_opt_out', 'content_guidelines', 'us_export_laws'])) {
      util.waitForSavedDocument();
    }
